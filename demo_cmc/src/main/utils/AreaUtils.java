	...
	public static boolean isAinsideB(VerticesArea vertA, VerticesArea vertB){
		...
		switch (dire) {
			case D_ABAJO:
				...
				if(dire2.equals(Direccion.ARRIBA) || dire2.equals(Direccion.IZQUIERDA) || dire2.equals(Direccion.I_ARRIBA))
					return true;
				break;
			case ABAJO:
				dire2 =PuntoUtils.direccionRelativa(vertA.getInferiorIzquierdo(),vertB.getSuperiorIzquierdo());
				if(dire2.equals(Direccion.ARRIBA))
					return true;
				break;
			case DERECHA:
				dire2 =PuntoUtils.direccionRelativa(vertA.getInferiorIzquierdo(),vertB.getSuperiorIzquierdo());
				if(dire2.equals(Direccion.IZQUIERDA))
					return true;
				break;
			case I_ABAJO:
				dire2 =PuntoUtils.direccionRelativa(vertA.getInferiorIzquierdo(),vertB.getSuperiorDerecho());
				if(dire2.equals(Direccion.ARRIBA) || dire2.equals(Direccion.D_ARRIBA))
					return true;
				break;
			case ARRIBA:
			...
			case D_ARRIBA:
				dire2 =PuntoUtils.direccionRelativa(vertA.getSuperiorIzquierdo(),vertB.getInferiorIzquierdo());
				if(dire2.equals(Direccion.DERECHA) || dire2.equals(Direccion.D_ABAJO))
					return true;
				break;
			case IGUAL:
				return true;
